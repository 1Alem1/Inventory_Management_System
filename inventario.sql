...
(1, 'Mateo', 'admin@gmail.com', '$2y$10$wLBfKfdNDf7IYB8X0rOem.chw.9Rni63ybjgp5zSuIy4p0/zUKwHm', 'admin'),
(2, 'Alejandro', 'tecnico@gmail.com', '$2y$10$576MZvmMUt6yeuQPjJsWeubEKJKAam4wYQ/u.J6iV37nu6B2xd.bm', 'tecnico');
...
ALTER TABLE `movimientos`
  ...
  ADD KEY `MovimientosxPedido` (`IDPedido`);
...
--
ALTER TABLE `movimientos`
  ADD CONSTRAINT `MovimientosxPedido` FOREIGN KEY (`IDPedido`) REFERENCES `pedidos` (`IDPedido`),
